                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <form method="POST" id="Formulario_Usuario">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="apellidos_usuario" type="text" class="form-control" id="apellidos_usuario" 
                        value="<?php echo $datos["apellidos"];  ?>" onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()" required>
                      </div>
                    </div>
