            ...
            <div class="card-body pt-3">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">FICHA</div>
                    <div class="col-lg-9 col-md-8">
                       <?php  
                         echo $datos["ficha"];
                       ?>
                  ...
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">PROGRAMA</div>
                    <div class="col-lg-9 col-md-8">
                       <?php  
                         echo $datos["programa"];
                       ?>
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <form method="POST" id="Formulario_Aprendiz">
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        ...
                        value="<?php echo $datos["nombres"];  ?>" onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()" disabled>
                      </div>
                    </div>

                    <div class="row mb-3">
                      <label for="primer apellido" class="col-md-4 col-lg-3 col-form-label">APELLIDOS</label>
                      <div class="col-md-8 col-lg-9">
                        <input name="primer_apellido_usuario" type="text" class="form-control" id="primer_apellido_usuario" 
                        value="<?php echo $datos["apellidos"];  ?>" onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()" disabled>
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        ...
                        <input  type="hidden"  name="id_usuario" id="id_usuario" value="<?php  echo $_SESSION["sesion_active"]["id_aprendiz"];  ?>" >
                      </div>
                    </div>
