<main id="main" class="main">
                                            ...
                                            <div class="card col" style="width: 19rem;">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div style="text-align: center">
                                                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#ModalPeticiones">Ver <i class="bi bi-eye-fill"></i></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="card col" style="width: 19rem;">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-text"></p>
                                                    <div style="text-align: center">
                                                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#ModalEnvio">Ver <i class="bi bi-eye-fill"></i></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
    ...
    <!--MODAL DE PETICIONES-->
    <div class="modal fade" id="ModalPeticiones" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <?php
                        if ($id_sede == 1) {
                    ?>
                        <table class="table" id="tablaPeticionesRecibidasEmpresa" style="width:100%">
                            <thead>
                                <tr>
                                    <th scope="col">#</th>
        ...
        <div class="modal fade" id="ModalValidarPeticion" tabindex="-1">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <input type="hidden" id="idValidacion" value="ID VALIDACION">
                    <div class="modal-body">
                        <div class="container">
                            <div class="row">
                                    <div class="col-6">
                            ...
                            <div class="row">
                                <div class="mb-3">
                                    <b>ACLARACIONES:</b>
                                    <textarea class="form-control" id="motivoPet" name="motivoPet" rows="3" placeholder="..." required></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
