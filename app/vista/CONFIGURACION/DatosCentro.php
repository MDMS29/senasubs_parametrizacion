  ...
  <br>
     ...
     <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
               <h1 class="card-title" style="font-size:30px;">CENTRO &nbsp;&nbsp;&nbsp;&nbsp;<button class="btn btn-primary AbrirModalCentro" type="submit" style="height: 50px;" data-bs-toggle="modal" data-bs-target="#ModalRegistroCentro">AGREGAR</button></h1>
             </div>
           </div>
         </div>
      </div>
             ...
             <div class="container">
               <div class="row">
                 <div class="col-12">
                    ...
                    <br>
                    <select class="selectpicker" data-live-search="true" data-width="100%" data-size="3" name="regional" id="regional"  >                      
                    </select>
            ...
            <div class="modal-body">
             <div class="container">
               <div class="row">
                 <div class="col-12">
                    <b>SELECCIONE UNA REGIONAL:</b> 
                    <select class="form-select" data-live-search="true" data-size="3" name="regionale" id="regionale"  >                      
                    </select>
                  </div>
                </div>
                <br>
