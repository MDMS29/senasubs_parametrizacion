  ...
  <script src="public/assets/js/Excel.js?n=4"></script>
  <script src="public/assets/js/Configuracion.js?n=4"></script>
  <script src="public/assets/js/Fidelizacion.js?n=4"></script>
  <script src="public/assets/js/Reportes.js?n=4"></script>
